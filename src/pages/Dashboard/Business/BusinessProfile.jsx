...
export const BusinessProfile = ({ section }) => {
  ...
  const setVis = (key, val) => setVisibility(prev => ({ ...prev, [key]: val }));
  ...
  const renderContact = () => (
    <div className="biz-section glass-panel">
      ...
      {[
        ...
        <div key={key} className="biz-contact-row" style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '16px' }}>
          <label className="form-label biz-contact-label" style={{ display: 'flex', alignItems: 'center', gap: '6px', margin: 0 }}>
            <Icon size={13} /> {label}
          </label>
          <div className="biz-contact-input-wrap" style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
            <input
              className="form-input"
              value={val || ''}
  ...
  const renderSocial = () => (
    <div className="biz-section glass-panel">
      <div className="biz-section-header-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
      ...
      <div className="biz-field-row" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        {[
          ...
          { key: 'whatsappChannel', label: 'WhatsApp Channel (optional)', Icon: WhatsAppIcon, placeholder: 'https://chat.whatsapp.com/...' },
          { key: 'telegramChannel', label: 'Telegram Channel (optional)', Icon: TelegramIcon, placeholder: 'https://t.me/...' },
